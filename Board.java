...
public class Board extends JPanel
{
    ...
    //Static array list that is shared across all classses
    public static ArrayList<int[]> undoRedoArray = new ArrayList<int[]>();
    public static int undoRedoIndex;
    ...
    public Board(JLabel statusbar, int noOfMines, int noOfRows, int noOfCols)
    {
        ...
        undoRedoIndex = 0;//Set the undo/redo index back to 0
